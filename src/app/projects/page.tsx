      ...
      <section className="container-page pt-32">
        <div className="max-w-4xl">
          ...
          <h1 className="display mt-6 text-balance">
            Applied software work across AI, automation, and full-stack platforms.
          </h1>
          <p className="lead mt-7">
            Each project below keeps the factual source material intact while presenting the work as a clearer case
            study: problem, solution, impact, and technologies.
          </p>
        </div>
      </section>
        ...
        <div className="dark-panel grid gap-6 p-8 sm:p-10 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-slate-300">
              Bring the idea, workflow, product brief, or legacy system. The goal is to turn it into a clear technical
              path.
            </p>
          </div>
