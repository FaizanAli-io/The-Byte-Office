    ...
    <div className="page-shell">
      ...
      <section className="container-page pt-32">
        <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-end">
          <div>
            ...
            <h1 className="display mt-6 text-balance">Software services for launch, scale, and smarter operations.</h1>
          </div>
          <p className="lead">
            {company.name} helps teams build full-stack products, automate workflows, connect business systems, and turn
            AI into practical software. Every service is focused on business outcomes, not a wall of buzzwords.
          </p>
        </div>
      </section>
        ...
        <div className="container-page grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <p className="mt-5 text-slate-300">
              The work moves from clarity to architecture to implementation, with testing and launch readiness built
              into the process.
            </p>
          </div>
      ...
      <section className="container-page section-tight">
        <div className="surface-card grid gap-6 p-8 sm:p-10 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            <h2 className="heading-lg">Need a product, AI workflow, or automation scoped?</h2>
            <p className="body-copy mt-3">
              Share the business goal and current constraints. The next step is a practical technical conversation.
            </p>
          </div>
