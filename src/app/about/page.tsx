...
export default function About() {
  const features = [
    ...
    },
    {
      ...
      description:
        "We stay current with emerging tech to provide cutting-edge solutions.",
    },
    {
      icon: "🤝",
    ...
    },
    {
      ...
      description:
        "Track record of delivering projects that drive measurable business impact.",
    },
    {
      icon: "🛡️",
    ...
    <div className="relative bg-black min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          subtitle={
            <>
              We're passionate technologists dedicated to transforming
              businesses through{" "}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-6">
              At The Byte Office, we believe that every business deserves access
              to cutting-edge technology. Our mission is to democratize AI and
              automation, making these powerful tools accessible to
              organizations of all sizes.
            </p>
            <p className="text-gray-300 text-lg leading-relaxed">
              We combine deep technical expertise with a passion for innovation
              to deliver solutions that don't just meet requirements — they
              exceed expectations and drive real business transformation.
            </p>
          </div>
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-10 text-center hover:bg-white/10 hover:border-white/20 transition-all duration-300 shadow-xl">
            ...
            <p className="text-gray-300">
              To be the leading freelance agency that bridges the gap between
              emerging technologies and practical business solutions, empowering
