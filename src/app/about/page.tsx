...
export default function AboutPage() {
  ...
  return (
    <div className="page-shell">
      ...
      <section className="container-page pt-32">
        <div className="grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-end">
          <div>
            ...
            <h1 className="display mt-6 text-balance">Product-minded engineering for modern business software.</h1>
          </div>
          <p className="lead">
            {company.name} is a software development and AI solutions company focused on custom web applications, SaaS
            platforms, backend systems, AI agents, RAG systems, automation, and cloud-ready business tools.
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="dark-panel p-8">
            ...
            <p className="mt-5 text-slate-300">
              The mission is to help businesses use modern engineering and AI without turning projects into experiments.
              The work should create usable systems, cleaner operations, and products that can keep improving after
              launch.
            </p>
          </div>
          ...
          <div className="surface-card p-8">
            ...
            <p className="body-copy mt-5">
              The Byte Office starts by understanding the business problem behind the requested feature. From there, the
              work becomes a practical technical plan: interface, data, backend, AI or automation logic, integrations,
              testing, and deployment.
            </p>
            <p className="body-copy mt-4">
              The result is software that is easier for clients to trust: clearer user journeys, maintainable
              architecture, and less manual work hidden inside daily operations.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-page grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {services.map((service) => (
              <article key={service.title} className="rounded-md border border-white/10 bg-white/[0.04] p-5">
      ...
      <section className="container-page section">
        <SectionHeading eyebrow="Process" title="A simple client journey with technical clarity at every step." />
        ...
        <div className="surface-card grid gap-6 p-8 sm:p-10 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            ...
            <p className="body-copy mt-3">
              Share what you are trying to automate, launch, rebuild, or connect. The first step is a clear
              conversation.
            </p>
          </div>
