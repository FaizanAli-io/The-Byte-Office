export const siteUrl = process.env.NEXT_PUBLIC_SITE_URL?.replace(/\/$/, '') || 'https://thebyteoffice.com';
...
export const services = [
  {
    ...
    summary: 'Plan, design, and build web applications that are fast, secure, maintainable, and ready for real users.',
    outcome: 'Launch SaaS platforms, dashboards, portals, and internal tools without rebuilding the foundation later.',
    capabilities: [
  ...
  },
  {
    ...
    summary: 'Build practical AI products that connect language models to your data, workflows, and users.',
    outcome:
      'Turn AI experiments into useful assistants, copilots, and agentic workflows with guardrails and observability.',
    capabilities: ['AI agents', 'RAG systems', 'LangChain and LangGraph', 'OpenAI API integrations'],
  },
  {
    title: 'Automation Solutions',
    summary: 'Replace repetitive manual work with reliable workflows, integrations, and operational systems.',
    outcome:
      'Reduce handoffs, improve response time, and keep business data moving between the tools your team already uses.',
    capabilities: ['CRM automation', 'Lead capture workflows', 'API integrations', 'Business process optimization'],
  },
  {
    title: 'Cloud, Backend, and Data Systems',
    summary: 'Design the server-side pieces that keep modern products dependable as usage grows.',
    outcome:
      'Ship systems with cleaner APIs, safer data flows, and deployment practices that support long-term maintenance.',
    capabilities: ['FastAPI and Node.js', 'PostgreSQL and MongoDB', 'Cloud deployment', 'Data pipelines'],
  },
];
...
export const projects = [
  {
    ...
    problem: 'Teams needed a secure chat experience for AI agents with session-based messaging and connected tools.',
    solution: 'Built a platform experience with LangGraph orchestration, backend APIs, and a modern Next.js interface.',
    impact: 'Created a focused foundation for agent conversations, tool integrations, and secure user workflows.',
  ...
  },
  {
    ...
    problem: 'Field activity and submissions needed to be tracked in one operational view with location context.',
    solution: 'Delivered an internal analytics dashboard for agents, submissions, and geospatial activity.',
    impact: 'Helped operations teams monitor field work and centralize activity records in a structured system.',
  ...
  },
  {
    ...
    problem: 'A premium clinic needed a conversion-focused web experience for services, booking, and lead capture.',
    solution: 'Designed and built a high-end frontend with service detail pages, motion, and structured contact paths.',
    impact: "Improved the clinic's digital presentation with a polished service showcase built around inquiries.",
  ...
  },
  {
    ...
    problem: 'Lead intake, qualification, and follow-ups were spread across manual steps in the sales process.',
    solution: 'Connected Pipedrive with supporting automation scripts and handoff logic for a cleaner pipeline.',
    impact: 'Reduced repetitive CRM work and made follow-up activity more consistent across incoming leads.',
  ...
  },
  {
    ...
    problem: 'Client websites needed faster visitor response without manually monitoring every inquiry channel.',
    solution: 'Built a reusable WhatsApp automation bot that can integrate into multiple client sites.',
    impact: 'Gave businesses an instant conversational entry point for capturing and routing leads.',
  ...
  },
  {
    ...
    problem: 'Movement and posture analysis required a repeatable computer vision workflow instead of manual review.',
    solution: 'Created a pose-estimation prototype to analyze skiing posture and motion patterns.',
    impact: 'Demonstrated how computer vision can turn video into structured movement feedback.',
  ...
  },
  {
    ...
    problem: 'Users needed clearer access to answers grounded in legislative documents and policy material.',
    solution: 'Built an AI assistant using retrieval-augmented generation to answer questions from document context.',
    impact: 'Made complex legal and policy content easier to query while keeping answers tied to source material.',
