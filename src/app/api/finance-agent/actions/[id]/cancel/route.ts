import { AgentActionError, cancelPendingAgentAction } from '@/lib/finance-agent/actions';
...
export async function POST(_request: Request, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    const message = cause instanceof Error ? cause.message : 'Could not cancel action';
